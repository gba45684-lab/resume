/* Resume Studio template registry. Third-party PSD/FIG binaries and screenshots are not redistributed. */
const fonts=["Inter,Arial,sans-serif","Arial,Helvetica,sans-serif","Georgia,serif","Trebuchet MS,Arial,sans-serif","Verdana,Arial,sans-serif","Tahoma,Arial,sans-serif","Courier New,monospace","Times New Roman,serif","Garamond,Georgia,serif","Palatino Linotype,Georgia,serif"];
const colors=["#17181b","#243447","#1f4b6e","#365c4a","#5a3d5d","#6b4e2f","#8a3d3d","#3f4a68","#0f5965","#574b3e","#27364a","#6a3f2d","#3d4f5b","#2f5d50","#4b426b"];
