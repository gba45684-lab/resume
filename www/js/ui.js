...
(function(){
  ...
  document.addEventListener('click',(e)=>{
    ...
    if(b && sheet && !sheet.classList.contains('hidden')){
      setTimeout(()=>toast('Template applied'),80);
    }
  });
  ...
  if(searchInput){searchInput.setAttribute('aria-label','Search resume templates');searchInput.addEventListener('keydown',(e)=>{if(e.key==='Escape'){e.stopPropagation();e.currentTarget.value='';if(typeof renderTemplateGrid==='function')renderTemplateGrid()}})}
