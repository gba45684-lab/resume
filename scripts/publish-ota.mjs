...
const allowedCss = new Set(['css/style.css','css/components.css','css/ui-fixes.css','css/home-responsive-fix.css','css/templates-scroll-fix.css','css/premium-polish.css']);
const allowedScripts = new Set(['js/ota-bootstrap.js','js/templates.js','js/app.js','js/ui-integrity.js','js/editor-live.js','js/native-enhancements.js','js/template-direct-preview.js','js/preview-fullscreen-controls.js','js/template-filters-search-fix.js','js/screen-layout-fix.js']);
const assets = [
