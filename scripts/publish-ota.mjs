...
const allowedCss = new Set(['css/style.css','css/components.css','css/template-variants.css','css/ui-fixes.css']);
const allowedScripts = new Set(['js/ota-bootstrap.js','js/templates.js','js/app.js','js/ui-integrity.js','js/editor-live.js']);
const assets = [
